...
# from parliament.statement import translate_documentation_types
...
def translate_condition_key_data_types(str):
    """
    ...
    if str.lower() in ["arn", "arn"]:
        return "Arn"
    elif str.lower() in ["bool", "boolean"]:
        return "Bool"
    elif str.lower() in ["date"]:
        return "Date"
    elif str.lower() in ["long", "numeric"]:
        return "Number"
    elif str.lower() in ["string", "string", "arrayofstring"]:
        return "String"
    elif str.lower() in ["ip"]:
        return "Ip"
    else:
